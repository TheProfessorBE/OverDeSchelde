        ...
        <div class="font-sans bg-white shadow-lg p-4 max-w-5xl px-5 py-5 rounded-md">
            <div class="flex flex-col text-white ">
                ...
                <div class="grid text-ODS-900 text-lg bg-ODS-100 rounded-lg p-2">
                    ...
                    <p class="text-justify p-2"> Deze website is gebouwd door een gebruiker van het veer, om op een overzichtelijke manier de uren van de verschillende veerboten over de Schelde te kunnen raadplegen.
