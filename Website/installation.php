    ...
    <div class=" py-2"></div>
        <div class="font-sans bg-white shadow-lg p-4 max-w-5xl px-5 py-5 rounded-md">
            <div class="flex flex-col text-white ">
                ...
                <h1 class="my-6 text-center text-4xl font-semibold text-ODS-800">Over de Schelde?</h1>
                
                <div class="grid text-ODS-900 text-lg">
                ...
                <h2 class="my-6 text-left text-2xl font-semibold text-ODS-800">Installatie Android</h2>
