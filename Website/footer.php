...
<div class="text-ODS-600 gap-0.5 font-semibold">
    ...
    <div class="text-ODS-600 grid grid-cols-1 lg:grid-cols-3 gap-0.5 ">    
        <a class="hover:text-ODS-800 hover:bg-ODS-400 px-2 py-3 rounded-lg" href="https://www.agentschapmdk.be/nl/veerdiensten/veerdienst-kruibeke-hoboken" target="new">AMDK - Hemiksem/Bazel</a>
        <a class="hover:text-ODS-800 hover:bg-ODS-400 px-2 py-3 rounded-lg " href="https://www.agentschapmdk.be/nl/veerdiensten/veerdienst-kruibeke-hoboken" target="new">AMDK - Hoboken/Kruibeke</a>
        <a class="hover:text-ODS-800 hover:bg-ODS-400 px-2 py-3 rounded-lg" href="https://www.agentschapmdk.be/nl/veerdiensten/veerdienst-sint-anna" target="new">AMDK - Sint-Anna/Antwerpen</a>
    </div>
</div>
...
<div class="text-s text-ODS-400 flex items-center justify-center space-x-6">
    <p class="mr-2">Designed by TheProfessorBE for fun and utility. No ads yet, but if you like it, support is appreciated! </p>
...
<div class="text-xs text-ODS-400">
    <p>
    <b>Disclaimer:</b> The information provided on this website is for general informational purposes only. While we strive to 
    ...
    from the use of this website or the information provided.
    </p>
</div>