...
const departuresLoWeek = ['7:00', '7:30', '8:00', '8:30', '9:00', '9:30', '10:00', '10:30', '11:00', '11:30', '12:00', '12:30', '13:00', '13:30', '14:00', '14:30', '15:00', '15:30', '16:00', '16:30', '17:00', '17:30', '18:00'];
const departuresAntwerpenWeek = ['7:15', '7:45', '8:15', '8:45', '9:15', '9:45', '10:15', '10:45', '11:15', '11:45', '12:15', '12:45', '13:15', '13:45', '14:15', '14:45', '15:15', '15:45', '16:15', '16:45', '17:15', '17:45', '18:15'];
const departuresLoWeekend = ['10:00', '10:30', '11:00', '11:30', '12:00', '12:30', '13:00', '13:30', '14:00', '14:30', '15:00', '15:30', '16:00', '16:30', '17:00', '17:30', '18:00', '18:30', '19:00', '19:30', '20:00', '20:30', '21:00'];
const departuresAntwerpenWeekend =  ['10:15', '10:45', '11:15', '11:45', '12:15', '12:45', '13:15', '13:45', '14:15', '14:45', '15:15', '15:45', '16:15', '16:45', '17:15', '17:45', '18:15', '18:45', '19:15', '19:45', '20:15', '20:45', '21:15'];


const holidays2023 = [ '2023-01-01', '2023-04-10', '2023-05-01', '2023-05-18', '2023-05-29', '2023-07-21', '2023-08-15', '2023-11-01', '2023-11-11', '2023-12-25' ];
const holidays2024 = ['2024-01-01', '2024-04-01', '2024-05-01', '2024-05-09', '2024-05-20', '2024-07-21', '2024-08-15', '2024-11-01','2024-11-11', '2024-12-25' ];
const holidays2025 = ['2025-01-01','2025-04-21','2025-05-01','2025-05-29','2025-06-09','2025-07-21','2025-08-15','2025-11-01','2025-11-11','2025-12-25'];
const holidays2026 = ['2026-01-01','2026-04-06','2026-05-01','2026-05-14','2026-05-25','2026-07-21','2026-08-15','2026-11-01','2026-11-11','2026-12-25'];
const holidays = holidays2023.concat(holidays2024, holidays2025, holidays2026);

/*
function writeNextDepartures(){
    ...
    let tableHtmlBazel = '<table class="timerow"><tr><th>Bazel</th></tr>';
    ...
    let tableHtmlHemiksem = '<table class="timerow"><tr><th>Hemiksem</th></tr>';
    ...
    let tableHtmlKruibeke = '<table class="timerow"><tr><th>Kruibeke</th></tr>';
    ...
    let tableHtmlHoboken = '<table class="timerow"><tr><th>Hoboken</th></tr>';
